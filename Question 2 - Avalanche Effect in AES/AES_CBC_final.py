#Καλούμε τις βιβλιοθήκες από την Pycryptodome
...
#Δημιουργούμε ένα κλειδί σε μορφή bit μεγέθους 16 byte (128bit)
key = get_random_bytes(16)
#print(key)

#Δημιουργούμε το cipher με το οποιο θα κρυπτογραφήσουμε το text μας
cipher = AES.new(key,AES.MODE_CBC)

print("Cipher is:")
print(cipher)

#Ελέγχουμε την αρχικοποίηση
print("Cipher IV is:")
print(cipher.iv)
